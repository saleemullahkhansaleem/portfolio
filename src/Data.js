...
export const Data = {
  ...
  services: [
    ...
    },
    {
      ...
      longDescription:
        "Get expert advice and guidance on your web development projects with our technical consulting services. Whether you're planning a new project, evaluating technology options, or facing technical challenges, our team of experienced consultants can help you navigate complex decisions and make informed choices. From architecture design and technology selection to performance optimization and scalability planning, we provide tailored solutions to address your specific needs and requirements. With a focus on collaboration and knowledge sharing, we empower you to make strategic decisions that drive business success and achieve your goals.",
    },
    {
      ...
      longDescription:
        "Equip your team with the skills and knowledge they need to succeed with our training and workshop sessions. Whether you're onboarding new team members, upskilling existing staff, or looking to expand your team's expertise, our training programs cover a wide range of topics related to web development and React. From fundamental concepts like HTML, CSS, and JavaScript to advanced topics like React components, state management, and performance optimization, we offer hands-on training sessions that empower participants to apply their learnings in real-world scenarios. With a focus on practical skills and interactive learning experiences, our workshops help you build a strong and capable team that drives innovation and delivers results.",
    },
    {
    ...
    },
    {
      ...
      longDescription:
        "Enhance your web development workflow with custom web components that promote consistency, reusability, and maintainability. Our custom web component development service allows you to create reusable UI elements and widgets that encapsulate functionality and styling, making it easy to build complex interfaces with minimal code duplication. Whether you're building a design system for your organization or creating a library of reusable components for your projects, our team works closely with you to design and implement custom web components that align with your brand identity and user experience goals. From buttons and form elements to complex widgets and interactive charts, we help you build a library of modular components that accelerate development and promote collaboration across your team.",
    },
    {
